...
instance Print OperatorSymbol where
  prt _ (OperatorSymbol i) = doc (showString ( i))
...
instance Print Space where
  prt i e = case e of
    TWhitespace -> prPrec i 0 (concatD [doc (showString "!#!")])

instance Print Operator where
  prt i e = case e of
    TInfixOp operatorsymbol -> prPrec i 0 (concatD [prt 0 operatorsymbol])
    TPrefixOp operatorsymbol -> prPrec i 0 (concatD [prt 0 operatorsymbol])

instance Print OPerator where
  prt i e = case e of
    TPostfixOp operatorsymbol -> prPrec i 0 (concatD [prt 0 operatorsymbol])
