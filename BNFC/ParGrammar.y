...
L_Id { PT _ (T_Id $$) }
L_OperatorSymbol { PT _ (T_OperatorSymbol $$) }
...
Id    :: { Id} : L_Id { Id ($1)}
OperatorSymbol    :: { OperatorSymbol} : L_OperatorSymbol { OperatorSymbol ($1)}
...
Space :: { Space }
Space : '!#!' { AbsGrammar.TWhitespace }
Operator :: { Operator }
Operator : OperatorSymbol { AbsGrammar.TInfixOp $1 }
         | OperatorSymbol { AbsGrammar.TPrefixOp $1 }
OPerator :: { OPerator }
OPerator : OperatorSymbol { AbsGrammar.TPostfixOp $1 }
TypeDecl :: { TypeDecl }
